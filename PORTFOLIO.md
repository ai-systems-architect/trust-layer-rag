...
**Context entities recall** — RAGAs entity-level retrieval metric to verify key identifiers (MAP-1.1, AC-2) are not dropped during retrieval. Defer until Recall@k and MRR baselines are established.
